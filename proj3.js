...
function fight() {
    ...
    battleLog.innerHTML = playerPokemon.name + " HP: " + playerPokemon.hp + "<br>" +
                          enemyPokemon.name + " HP: " + enemyPokemon.hp;
}
...
var square1 = new Rect(50, 50, 50, 50);
square1.setColor("blue");
square1.setCollisions(true, "Dynamic");
var square2 = new Rect(100, 100, 50, 50);
square2.setColor("black");
var square3 = new Rect(250, 100, 50, 50);
...
for(var i = 0; i < str.length;i++) {
    if(str.charAt(i) === 'o') {
        var temp = new Rect(temp_x, temp_y, 50, 50);
        temp.setColor("grey");
        temp.setCollisions(true, "Static");
        temp_x = temp_x + 50;
        obj_arr.push(temp);
    }
    else {
...
function mainLoop() {
    ...
    switch(current_scene) {
        case "TEST": {
            ...
            if(CollisionSolver.testInside(square1, square2) == true) {
                square2.setColor("red");
            }
            else {
                square2.setColor("black");
            }
            if(CollisionSolver.testCollisions(square1, square3) == true) {
